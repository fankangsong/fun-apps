...
- [x] **Step 1: 创建 `jump-jump/index.html` 完整骨架**
...
- [x] **Step 1: 创建 `jump-jump/config.js`**
...
- [x] **Step 1: 创建 `jump-jump/state.js`**
...
- [x] **Step 1: 创建 `jump-jump/physics.js`**
...
- [x] **Step 1: 创建 `jump-jump/input.js`**
...
- [x] **Step 1: 创建 `jump-jump/render.js`**
